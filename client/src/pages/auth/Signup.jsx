...
export default function Signup() {
  ...
  return (
   <div className="min-h-screen px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-3xl p-6 sm:p-8 md:p-10 my-8 rounded-2xl shadow-lg bg-white/70 dark:bg-black/20 backdrop-blur-md border border-gray-200/50 dark:border-white/10 text-gray-800 dark:text-white">
